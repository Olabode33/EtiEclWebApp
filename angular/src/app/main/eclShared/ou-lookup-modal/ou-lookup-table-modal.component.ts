...
@Component({
    selector: 'ouLookupTableModal',
    styleUrls: ['./ou-lookup-table-modal.component.less'],
    encapsulation: ViewEncapsulation.None,
    templateUrl: './ou-lookup-table-modal.component.html'
})
export class OuLookupTableModalComponent extends AppComponentBase {
