import { CalibrationStatusEnum, CreateOrEditCalibrationRunDto, CommonLookupServiceProxy, NameValueDtoOfInt64, CalibrationEadCcfSummaryServiceProxy, FrameworkEnum } from '../../../../shared/service-proxies/service-proxies';
...
@Component({
    templateUrl: './calibrateEadCcfSummary.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()]
})
export class CalibrationEadCcfSummaryComponent extends AppComponentBase implements OnInit {
    ...
    constructor(
        injector: Injector,
        private _calibrationServiceProxy: CalibrationEadCcfSummaryServiceProxy,
    ...
    view(id: string): void {
        this._router.navigate(['/app/main/calibration/ccfSummary/view/', id]);
    }
