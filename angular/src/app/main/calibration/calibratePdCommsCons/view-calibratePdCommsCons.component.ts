...
@Component({
    selector: 'viewCalibrationPdCommsCons',
    templateUrl: './view-calibratePdCommsCons.component.html',
    animations: [appModuleAnimation()]
})
export class ViewCalibrationPdCommsConsComponent extends AppComponentBase implements OnInit, AfterViewInit {
    ...
    totalUploads = 0;
    totalHistoric = 0;
    uploads: InputPdCommsConsDto[] = new Array();
    historic: InputPdCommsConsDto[] = new Array();
    commsCons: ResultNewPdCommsConsDto[] = new Array();
    ...
    constructor(
        ...
        super(injector);
        this.uploadUrl = AppConsts.remoteServiceBaseUrl + '/CalibrationData/ImportPdCommsConsFromExcel';
