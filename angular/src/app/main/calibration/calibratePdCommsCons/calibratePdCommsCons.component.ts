import { CalibrationStatusEnum, CreateOrEditCalibrationRunDto, CommonLookupServiceProxy, NameValueDtoOfInt64, CalibrationEadCcfSummaryServiceProxy, CalibrationLgdHairCutServiceProxy, CalibrationLgdRecoveryRateServiceProxy, CalibrationPdCrDrServiceProxy, FrameworkEnum, CalibrationPdCommsConsServiceProxy } from '../../../../shared/service-proxies/service-proxies';
...
@Component({
    templateUrl: './calibratePdCommsCons.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()]
})
export class CalibrationPdCommsConsComponent extends AppComponentBase implements OnInit {
    ...
    view(id: string): void {
        this._router.navigate(['/app/main/calibration/pdcommscons/view/', id]);
    }
