import { CalibrationStatusEnum, CreateOrEditCalibrationRunDto, CommonLookupServiceProxy, NameValueDtoOfInt64, CalibrationEadCcfSummaryServiceProxy, CalibrationLgdHairCutServiceProxy, FrameworkEnum } from '../../../../shared/service-proxies/service-proxies';
...
@Component({
    templateUrl: './calibrateLgdHaircut.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()]
})
export class CalibrationLgdHaircutComponent extends AppComponentBase implements OnInit {
    ...
    constructor(
        injector: Injector,
        private _calibrationServiceProxy: CalibrationLgdHairCutServiceProxy,
    ...
    view(id: string): void {
        this._router.navigate(['/app/main/calibration/haircut/view/', id]);
    }
