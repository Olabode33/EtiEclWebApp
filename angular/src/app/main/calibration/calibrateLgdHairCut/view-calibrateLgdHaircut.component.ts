import { InputBehaviouralTermsDto, ResultBehaviouralTermsDto, CalibrationEadCcfSummaryServiceProxy, InputCcfSummaryDto, ResultEadCcfSummaryDto, CalibrationLgdHairCutServiceProxy, InputLgdHaircutDto, ResultLgdHairCutSummaryDto, GetCalibrationUploadSummaryDto, CommonLookupServiceProxy } from '../../../../shared/service-proxies/service-proxies';
...
@Component({
    selector: 'viewCalibrationLgdHaircut',
...
export class ViewCalibrationLgdHaircutComponent extends AppComponentBase implements OnInit, AfterViewInit {
    ...
    constructor(
        ...
        super(injector);
        this.uploadUrl = AppConsts.remoteServiceBaseUrl + '/CalibrationData/ImportLgdHaircutFromExcel';
    ...
    getResults(): void {
        this._calibrationServiceProxy.getResult(this._calibrationId).subscribe(result => {
            this.result = result.haircutSummary;
        });
    }
