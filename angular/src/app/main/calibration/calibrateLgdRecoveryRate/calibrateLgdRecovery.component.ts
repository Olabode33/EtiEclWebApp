...
@Component({
    templateUrl: './calibrateLgdRecovery.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()]
})
export class CalibrationLgdRecoveryComponent extends AppComponentBase implements OnInit {
    ...
    view(id: string): void {
        this._router.navigate(['/app/main/calibration/recovery/view/', id]);
    }
