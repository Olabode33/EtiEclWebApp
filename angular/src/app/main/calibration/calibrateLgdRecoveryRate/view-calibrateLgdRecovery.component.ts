...
@Component({
    selector: 'viewCalibrationLgdRecovery',
...
export class ViewCalibrationLgdRecoveryComponent extends AppComponentBase implements OnInit, AfterViewInit {
    ...
    constructor(
        ...
        private _calibrationServiceProxy: CalibrationLgdRecoveryRateServiceProxy,
        ...
        super(injector);
        this.uploadUrl = AppConsts.remoteServiceBaseUrl + '/CalibrationData/ImportLgdRecoveryRateFromExcel';
