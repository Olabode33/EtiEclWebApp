...
using TestDemo.Authentication.TwoFactor.Google;
using TestDemo.Authorization.Users.Dto;
using TestDemo.Authorization.Users.Profile.Cache;
using TestDemo.Authorization.Users.Profile.Dto;
using TestDemo.Friendships;
using TestDemo.Gdpr;
using TestDemo.Identity;
using TestDemo.Net.Sms;
using TestDemo.Security;
using TestDemo.Storage;
using TestDemo.Timing;

namespace TestDemo.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : TestDemoAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("TestDemo",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("TestDemo",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
