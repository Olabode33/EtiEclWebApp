...
namespace TestDemo.Calibration
{
    ...
    public class CalibrationLgdHairCutAppService : TestDemoAppServiceBase, ICalibrationsAppService
    {
        ...
        public async Task<CalibrationInputSummaryDto<InputLgdHaircutDto>> GetHistorySummary(EntityDto<Guid> input)
        {
        ...
        public async Task ApplyToEcl(EntityDto<Guid> input)
        {
            ...
            if (calibration.Status == CalibrationStatusEnum.Completed)
            {
                ...
                await _backgroundJobManager.EnqueueAsync<SaveHistoricLgdHaircutDataJob, ImportCalibrationDataFromExcelJobArgs>(new ImportCalibrationDataFromExcelJobArgs
                {
        ...
        public async Task Erase(EntityDto<Guid> input)
        {
            ...
            if (calibration.Status != CalibrationStatusEnum.AppliedToEcl)
            {
                ...
                {
                    EraseType = TrackTypeEnum.CalibrateHaircut,
                    GuidId = input.Id
                });
            }
            else
        ...
        public async Task SendSubmittedEmail(Guid calibrationId)
        {
            ...
            var link = baseUrl + "/app/main/calibration/haircut/view/" + calibrationId;
