...
namespace TestDemo.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : TestDemoAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<TestDemoDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(TestDemoConsts.ConnectionStringName).Value.ToString();
        }
