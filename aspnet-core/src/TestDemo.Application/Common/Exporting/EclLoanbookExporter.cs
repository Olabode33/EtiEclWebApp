...
{
    public class EclLoanbookExporter : EpPlusExcelExporterBase, IEclLoanbookExporter
    {
        public EclLoanbookExporter(ITempFileCacheManager tempFileCacheManager)
             : base(tempFileCacheManager)
        {
        }

        public FileDto ExportToFile(List<EclDataLoanBookDto> inputDtos)
        {
            return CreateExcelPackage(
                "ExcelLoanbookImportList.xlsx",
                excelPackage =>
                {
                    var sheet = excelPackage.Workbook.Worksheets.Add(L("ExcelLoanbookImports"));
