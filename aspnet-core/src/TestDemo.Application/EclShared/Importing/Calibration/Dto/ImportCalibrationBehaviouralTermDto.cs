...
namespace TestDemo.EclShared.Importing.Calibration.Dto
{
    ...
    public class ImportCalibrationBehaviouralTermAsStringDto
    {
        public string Customer_No { get; set; }
        public string Account_No { get; set; }
        public string Contract_No { get; set; }
        ...
        public string Classification { get; set; }
        public string Original_Balance_Lcy { get; set; }
        public string Outstanding_Balance_Lcy { get; set; }
        public string Outstanding_Balance_Acy { get; set; }
    ...
    [Serializable]
    public class SaveCalibrationBehaviouralTermExcelJobArgs
    {
        public ImportCalibrationDataFromExcelJobArgs Args { get; set; }
        public List<ImportCalibrationBehaviouralTermAsStringDto> UploadedRecords { get; set; }
    }
}
