...
{
    public class InvalidLgdHaircutExporter : EpPlusExcelExporterBase, IInvalidLgdHaircutExporter
    {
        public InvalidLgdHaircutExporter(ITempFileCacheManager tempFileCacheManager)
             : base(tempFileCacheManager)
        {
        }

        public FileDto ExportToFile(List<ImportCalibrationLgdHaircutDto> inputDtos)
        {
            return CreateExcelPackage(
                "InvalidLgdHaircutImportList.xlsx",
                excelPackage =>
                {
                    var sheet = excelPackage.Workbook.Worksheets.Add(L("InvalidLgdHaircutImportList"));
