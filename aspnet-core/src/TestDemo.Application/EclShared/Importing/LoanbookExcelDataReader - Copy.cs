...
{
    public class LoanbookExcelDataReader_ : EpPlusExcelImporterBase<ImportLoanbookDto>//, ILoanbookExcelDataReader_
    {
        private readonly ILocalizationSource _localizationSource;

        public LoanbookExcelDataReader_(ILocalizationManager localizationManager)
        {
