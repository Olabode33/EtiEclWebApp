...
using TestDemo.DemoUiComponents.Dto;

namespace TestDemo.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : TestDemoAppServiceBase, IDemoUiComponentsAppService
    {
