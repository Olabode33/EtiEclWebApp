...
{
	[AbpAuthorize(AppPermissions.Pages_AffiliateMacroEconomicVariableOffsets)]
    public class AffiliateMacroEconomicVariableOffsetsAppService : TestDemoAppServiceBase, IAffiliateMacroEconomicVariableOffsetsAppService
    {
		...
		_lookup_macroeconomicVariableRepository = lookup_macroeconomicVariableRepository;
		 ...
		 [AbpAuthorize(AppPermissions.Pages_AffiliateMacroEconomicVariableOffsets_Edit)]
		 ...
		 [AbpAuthorize(AppPermissions.Pages_AffiliateMacroEconomicVariableOffsets_Create)]
		 ...
		 [AbpAuthorize(AppPermissions.Pages_AffiliateMacroEconomicVariableOffsets_Delete)]
