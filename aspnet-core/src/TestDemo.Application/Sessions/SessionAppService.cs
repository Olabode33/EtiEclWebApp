...
{
    public class SessionAppService : TestDemoAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = TestDemoConsts.Currency,
                    CurrencySign = TestDemoConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = TestDemoConsts.AllowTenantsToChangeEmailSettings
                }
            };
