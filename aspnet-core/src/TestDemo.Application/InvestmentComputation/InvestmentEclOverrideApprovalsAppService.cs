...
namespace TestDemo.InvestmentComputation
{
    ...
    public class InvestmentEclOverrideApprovalsAppService : TestDemoAppServiceBase, IInvestmentEclOverrideApprovalsAppService
    {
        ...
        public async Task<EclAuditInfoDto> GetEclAudit(EntityDto<Guid> input)
        {
            ...
            var filteredInvestmentEclApprovals = _investmentEclOverrideApprovalRepository.GetAll()
                        .Include(e => e.ReviewedByUserFk)
            ...
            var eclOverride = await _lookup_investmentEclOverrideRepository.FirstOrDefaultAsync(input.Id);
