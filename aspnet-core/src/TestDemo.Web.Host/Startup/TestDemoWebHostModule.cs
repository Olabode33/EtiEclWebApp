...
namespace TestDemo.Web.Startup
{
    ...
    public class TestDemoWebHostModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public TestDemoWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TestDemoWebHostModule).GetAssembly());
        }
