...
namespace TestDemo.EclShared
{
    ...
    {
        Draft, Submitted, Approved, Running, PreOverrideComplete, PostOverrideComplete, ComputedEAD, ComputedLGD, ComputedECL, Completed, Closed, AwaitngAdditionApproval, QueuePostOverride, Failed, LoadingAssumptions, ComputedPD
    }
