...
namespace TestDemo.EclShared
{
    ...
    {
        Draft, Submitted, Approved, Rejected, Processing, Completed, AwaitngAdditionApproval, Override
    }

    public enum CalibrationStatusEnum
    {
        Draft, Submitted, Approved, Rejected, Processing, Completed, AwaitngAdditionApproval, AppliedToEcl, QueuedForProcessing, Uploading, Failed
    }
    ...
    {
        General, EadInputAssumption, LgdInputAssumption, PdInputAssumption, PdSnPAssumption, PdMacroeconomicProjection, PdMacroeconomicInput, PdNonInternalModel, PdNplIndex, ReportingDate
    }
