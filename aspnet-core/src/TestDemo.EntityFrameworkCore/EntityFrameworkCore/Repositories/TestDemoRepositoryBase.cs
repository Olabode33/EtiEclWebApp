...
namespace TestDemo.EntityFrameworkCore.Repositories
{
    ...
    public abstract class TestDemoRepositoryBase<TEntity, TPrimaryKey> : EfCoreRepositoryBase<TestDemoDbContext, TEntity, TPrimaryKey>
    ...
    /// <summary>
    /// Base class for custom repositories of the application.
    /// This is a shortcut of <see cref="TestDemoRepositoryBase{TEntity,TPrimaryKey}"/> for <see cref="int"/> primary key.
    /// </summary>
    /// <typeparam name="TEntity">Entity type</typeparam>
