...
{
    public partial class Added_LoanImpairmentRecovery : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "LoanImpairmentRecoveries",
                columns: table => new
                {
                    ...
                    Recovery = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LoanImpairmentRecoveries", x => x.Id);
                });
        }
