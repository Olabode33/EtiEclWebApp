...
namespace TestDemo.Migrations.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = TestDemoConsts.MultiTenancyEnabled ? null : (int?)1;
        ...
        public DefaultLanguagesCreator(TestDemoDbContext context)
        {
            _context = context;
        }
