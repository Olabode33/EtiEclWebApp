...
using TestDemo.EntityFrameworkCore.Repositories;

namespace TestDemo.MultiTenancy.Payments
{
    public class SubscriptionPaymentRepository : TestDemoRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<TestDemoDbContext> dbContextProvider)
