...
using TestDemo.Web.Authentication.JwtBearer;
using TestDemo.Web.Authentication.TwoFactor;
using TestDemo.Web.Chat.SignalR;
using TestDemo.Web.Configuration;
...
namespace TestDemo.Web
{
    ...
    public class TestDemoWebCoreModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public TestDemoWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.DefaultNameOrConnectionString = _appConfiguration.GetConnectionString(
                TestDemoConsts.ConnectionStringName
            );
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(TestDemoApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TestDemoWebCoreModule).GetAssembly());
        }
        ...
        private void SetAppFolders()
        {
            ...
            {
                var currentAssemblyDirectoryPath = typeof(TestDemoWebCoreModule).GetAssembly().GetDirectoryPathOrNull();
