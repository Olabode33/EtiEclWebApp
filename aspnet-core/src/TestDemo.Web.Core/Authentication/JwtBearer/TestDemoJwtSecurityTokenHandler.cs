...
namespace TestDemo.Web.Authentication.JwtBearer
{
    public class TestDemoJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public TestDemoJwtSecurityTokenHandler()
        {
