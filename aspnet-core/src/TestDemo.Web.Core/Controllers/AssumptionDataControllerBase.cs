...
namespace TestDemo.Web.Controllers
{
    public abstract class AssumptionDataControllerBase : TestDemoControllerBase
    {
        ...
        [HttpPost]
        public async Task<JsonResult> ImportNonInternalModelFromExcel()
        {
            try
            {
                var file = Request.Form.Files.First();
        ...
        [HttpPost]
        public async Task<JsonResult> ImportNplModelFromExcel()
        {
            try
            {
                var file = Request.Form.Files.First();
        ...
        [HttpPost]
        public async Task<JsonResult> ImporMacroProjectionFromExcel()
        {
            try
            {
                var file = Request.Form.Files.First();
