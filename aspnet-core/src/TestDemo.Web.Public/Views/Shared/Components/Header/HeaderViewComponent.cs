...
using TestDemo.Url;
using TestDemo.Web.Public.Startup;
using TestDemo.Web.Session;

namespace TestDemo.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : TestDemoViewComponent
    {
