...
namespace TestDemo.Web.Public.Startup
{
    [DependsOn(
        typeof(TestDemoWebCoreModule)
    )]
    public class TestDemoWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public TestDemoWebFrontEndModule(IHostingEnvironment env, TestDemoEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TestDemoWebFrontEndModule).GetAssembly());
        }
    }
}
