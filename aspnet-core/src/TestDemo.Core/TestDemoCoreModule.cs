...
using TestDemo.Debugging;
using TestDemo.Features;
...
namespace TestDemo
{
    ...
    public class TestDemoCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            TestDemoLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, TestDemoMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<TestDemoSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TestDemoCoreModule).GetAssembly());
        }
