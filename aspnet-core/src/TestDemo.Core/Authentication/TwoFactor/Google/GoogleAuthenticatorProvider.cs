...
namespace TestDemo.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : TestDemoServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("TestDemo", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
