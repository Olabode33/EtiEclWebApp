...
namespace TestDemo.MultiTenancy.Payments.Stripe
{
    ...
    public class StripeGatewayManager : TestDemoServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "TestDemo";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + TestDemoConsts.Currency;
        }
