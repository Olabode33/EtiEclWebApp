...
using TestDemo.MultiTenancy.Demo;
...
namespace TestDemo.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(TestDemoConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
