...
using MvvmHelpers;
using TestDemo.Authorization.Users.Profile;
using TestDemo.Authorization.Users.Profile.Dto;
using TestDemo.Commands;
using TestDemo.Core.Threading;
using TestDemo.Models.NavigationMenu;
using TestDemo.Services.Navigation;
using TestDemo.ViewModels.Base;
using Plugin.Media;
...
using TestDemo.ApiClient;
using TestDemo.Controls;
using TestDemo.Dto;
using TestDemo.Extensions;
using TestDemo.Localization;
using TestDemo.UI;
using TestDemo.UI.Assets;
using TestDemo.Views;
using DependencyResolver = TestDemo.Core.Dependency.DependencyResolver;
...
namespace TestDemo.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "TestDemo";
