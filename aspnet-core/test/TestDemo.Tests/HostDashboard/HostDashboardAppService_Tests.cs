...
using TestDemo.MultiTenancy.HostDashboard;
...
namespace TestDemo.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(TestDemoDbContext context, SubscriptionPayment subscriptionPayment)
        {
